...
export const LOCAL_CHUNK_SIZE = 768 * 1024; // 768KB 一块（加密后≈786KB，仍低于 Cloudflare DO 的 1MB 单帧上限；增大分片→减少帧数→提升吞吐）
// 加密后单帧 ≈ 768KB + 16(IV) + ≤16(PKCS7填充) + 32(HMAC) + 12(帧头) ≈ 786.5KB
