...
export const sponsors: SponsorItem[] = [
  {
    ...
    link: '',
    title: '请我喝杯咖啡',
    desc: '我是一个独立的小开发者，也是「闪云 ArkPulse」的作者。不瞒你说，我对写代码其实并不算很在行，只是凭着一腔热爱，尽自己最大的努力把它一点点打磨出来。无论你是否愿意赞助，我都会继续发挥自己的一点余热，把这个工具认真做好——只希望它能在你传文件时，多带给你一点点省心和方便。你用得开心，就是对我最大的鼓励。',
  },
];
